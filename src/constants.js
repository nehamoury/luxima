export const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&q=80&w=800";
...
export const TESTIMONIALS = [
    {
        ...
        text: "LuxeHome has redefined how I source pieces for my clients. The craftsmanship is evident in every joint and fabric choice.",
        rating: 5
    },
    {
        id: 2,
        name: "Julian Brooks",
        role: "Home Owner",
        text: "The Velvet Cloud Sofa is truly like sitting on a cloud. The delivery team was professional and handled everything with care.",
        rating: 5
    },
    {
        id: 3,
        ...
        text: "Minimalism meets luxury. Every piece I've bought from the Scandi collection has become a conversation starter in my home.",
        rating: 5
    }
];
...
export const HERO_SLIDES = [
    {
        id: 1,
        title: "Sculpting Your Grandeur.",
        subtitle: "The Sovereign Living",
        description: "Transforming the quietest corners into statements of architectural dominance. Crafted with emerald velvet, marble, and precision.",
        image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=1600",
        cta: "The Sovereign Collection"
    },
    {
        id: 2,
        title: "Poetry in Structure.",
        subtitle: "The Ethereal Series",
        description: "Where geometry meets grace. A collection dedicated to the silent power of minimalist silhouettes and raw, honest textures.",
        image: "https://images.unsplash.com/photo-1616594111350-475261f3d456?auto=format&fit=crop&q=80&w=1600",
        cta: "View Ethereal Series"
    },
    {
        id: 3,
        title: "Crafted for the Occasion.",
        subtitle: "The Culinary Stage",
        description: "Beyond dining; a celebration of ritual. Solid walnut and sculptural form designed for the moments that define a home.",
        image: "https://images.unsplash.com/photo-1617806118233-18e19207af7a?auto=format&fit=crop&q=80&w=1600",
        cta: "Explore Dining"
    }
];

export const CATEGORIES = ['All', 'Living Room', 'Bedroom', 'Kitchen', 'Decor', 'Office'];
